...
function readText (form) {
    ...
    var LpstartDate = form.inputbox2.value;
    var LPendDate = form.inputbox3.value;
    var firstDisp = form.inputbox4.value;
    var secondDisp = form.inputbox5.value;
    var creditsWeeks = form.inputbox6.value;
    var program = form.inputbox7.value;
    var cCodes = form.inputbox8.value;
    var mpn = form.inputbox9.value;
    var sub = form.inputbox10.value;
    sub = sub.replace(/\$|,/g, '');
    var combined = form.inputbox11.value;
    combined = combined.replace(/\$|,/g, '');
    var totalCredits = form.inputbox12.value;
    var tuitionRate = form.inputbox13.value;
    tuitionRate = tuitionRate.replace(/\$|,/g, '');
    var allResources = form.inputbox14.value;
    allResources = allResources.replace(/\$|,/g, '');
    var subLoanAward = form.inputbox15.value;
    var unsubLoanAward = form.inputbox16.value;
    
    
    ////document.getElementById('coaRec').innerHTML = "WORKING";
    //document.getElementById('booksRec').innerHTML = "WORKING";
    //document.getElementById('loanFeeRec').innerHTML = "WORKING";
    //document.getElementById('livingRec').innerHTML = "WORKING";
    //document.getElementById('tuitionRec').innerHTML = "WORKING";
    //document.getElementById('aggLimitTB').innerHTML = "WORKING";
    //document.getElementById('noteRectangle').innerHTML = "WORKING";
   
    
    //document.getElementById('aggLimitTB_cj').innerHTML = "WORKING";
    ...
    var gradAggLimit = 57500;
    var gradAggLimitLeft = gradAggLimit - Math.abs(combined);
    
    document.getElementById("aggLimitTB_cj").style.fontSize = "23px";
    document.getElementById("aggLimitTB").style.fontSize = "23px";
    document.getElementById('aggLimitTB_cj').innerHTML = "$" + dollarUSLocale.format(gradAggLimitLeft);
    
    if  (isNaN(gradAggLimitLeft)){
        document.getElementById('aggLimitTB_cj').innerHTML = "Enter # (Agg Limit)" ;
        document.getElementById("aggLimitTB_cj").style.fontSize = "19px";
        document.getElementById("aggLimitTB_cj").style.color = "red";
        document.getElementById("aggLimitTB_cj").style.fontWeight = "700";
    ...
    if (gradAggLimitLeft < 0) {
        ...
        document.getElementById("aggLimitTB_cj").style.color = "green";
        document.getElementById("aggLimitTB_cj").style.fontWeight = "700";
    ...
    var subAgg = 23000;
    var subAggLimitLeft = subAgg - Math.abs(sub);
    
    document.getElementById('aggLimitTB').innerHTML = "$" + dollarUSLocale.format(subAggLimitLeft);
    
    if  (isNaN(subAggLimitLeft)){
    ...
    if (subAggLimitLeft < 0) {
      
        document.getElementById("aggLimitTB").style.color = "red";
        document.getElementById("aggLimitTB").style.fontWeight = "700";
        
        
    }else  if (subAggLimitLeft >= 0) {
    ...
    //Loan Eligibility
        ...
        // sub agg limit comparison
         ...
         //combined agg limit comparison
            ...
            if (sub0 > gradAggLimitLeft)
                {
                     sub0 = gradAggLimitLeft;
                         
                   
                }
        
        //COA calculation
            if(sub0 <= costOfAttendance)
                {
                    sub0 = sub0;
        ...
        //unsub combined agge
         ...
         if(combined0 <= gradAggLimitLeft)
            ...
            if (combined0 > gradAggLimitLeft)
                {
                     combined0 = gradAggLimitLeft;
                      unsub0 = combined0 - sub0;   
                   
                }
        
        var Owed2 = costOfAttendance  - sub0;
        ...
        combined0 = unsub0 +sub0;
               ...
               document.getElementById('unsubLAward_co').innerHTML = "$" + dollarUSLocale.format(sub0); 
               document.getElementById('unsubLAward_cp').innerHTML = "$" + dollarUSLocale.format(unsub0);
               document.getElementById('unsubLAward_cq').innerHTML = "$" + dollarUSLocale.format(combined0);
    ...
    if (sub0 <= 0) {
        ...
        document.getElementById("unsubLAward_co").style.color = "red";
        
        
    }else if((sub0 > 0))   {
        document.getElementById("unsubLAward_co").style.color = "green";
     ...
     if (unsub0 <= 0) {
        ...
        document.getElementById("unsubLAward_cp").style.color = "red";
        
        
    }else if((unsub0 > 0))   {
        document.getElementById("unsubLAward_cp").style.color = "green";
     ...
     if (combined0 <= 0) {
        ...
        document.getElementById("unsubLAward_cq").style.color = "red";
        
        
    }else if((combined0 > 0))   {
        document.getElementById("unsubLAward_cq").style.color = "green";
...
function myFunction1(form) {
   ...
   var unsubLoanAward = form.inputbox16.value; 
    ...
    var upperCase = firstDisp.replace(/\s/g,'')
    var upperCase2 = upperCase.toUpperCase();
    
    var secondUpper = secondDisp.replace(/\s/g,'')
    ...
    if (subLoanAward !== ''){
        ...
        document.getElementById('ituRec').innerHTML = sub1 ; 
    ...
    if (unsubLoanAward !== ''){
          ...
          document.getElementById('itemTypeTeach').innerHTML = unsub ; 
        
        if(upperCase2 === '2207'){
           document.getElementById('dispPlanTeach').innerHTML = "L" + julyD ; 
        }
         else if(upperCase2 === '2208'){
           document.getElementById('dispPlanTeach').innerHTML = "L" + augustD ; 
        }
        else if(upperCase2 === '2209'){
           document.getElementById('dispPlanTeach').innerHTML = "L" + septemberD ; 
        }
        else if(upperCase2 === '2210'){
           document.getElementById('dispPlanTeach').innerHTML = "L" + octoberD ; 
        }
        else if(upperCase2 === '2211'){
           document.getElementById('dispPlanTeach').innerHTML = "L" + novemberD ; 
        }
        else  if(upperCase2 === '2212'){
           document.getElementById('dispPlanTeach').innerHTML = "L" + decemberD ; 
        }
        else if(upperCase2 === '2301'){
           document.getElementById('dispPlanTeach').innerHTML = "L" + januaryD ; 
        }
         else if(upperCase2 === '2302'){
           document.getElementById('dispPlanTeach').innerHTML = "L" + febD ; 
        }
        else if(upperCase2 === '2303'){
           document.getElementById('dispPlanTeach').innerHTML = "L" + marchD ; 
        }
        else  if(upperCase2 === '2304'){
           document.getElementById('dispPlanTeach').innerHTML = "L" + aprilD ; 
        }
        else if(upperCase2 === '2305'){
           document.getElementById('dispPlanTeach').innerHTML = "L" + mayD ; 
        }
        else  if(upperCase2 === '2306'){
           document.getElementById('dispPlanTeach').innerHTML = "L" + juneD ; 
        }
        else if(upperCase2 === ''){
    ...
    var creditsWeeks = form.inputbox6.value;
    var tuitionRate1 = form.inputbox13.value;
    tuitionRate1 = tuitionRate1.replace(/\$|,/g, '');
    var program = form.inputbox7.value;
    var costofAttendance1 = document.getElementById('coaRec').innerHTML;
    var aggs1 = document.getElementById('aggLimitTB_cj').innerHTML;
    var nsldsAggLimit1 = form.inputbox11.value;
    ...
    var dollarIndianLocale = Intl.NumberFormat('en-IN');
       ...
       var note = "Packaged awards for " + "Unsubsidized Loan $" + dollarUSLocale.format(unsubLoanAward) + " & Subsidized Loan $" + dollarUSLocale.format(subLoanAward) + ". AY (1) begins " + loanPeriodSd + ", Total Credits/Weeks: " + creditsWeeks + ", " + "Program: "+ program + ". " + "Tuition Rate $" + dollarUSLocale.format(tuitionRate1) +". COA: " + costofAttendance1 + ". " + upperCase2 + " NSLDS borrowed $" + dollarUSLocale.format(nsldsAggLimit1) + ". " + aggs1 + " until aggregate limits reached. " + mpnUpperCase2  + " " + extra + " " + "Ready to Disburse."; 
        
        
    
    }
    else if (unsubLoanAward === '' && subLoanAward === ''){
    ...
    var dollarIndianLocale = Intl.NumberFormat('en-IN');
       ...
       var note = "Packaged awards for " + "Subsidized Loan $" + dollarUSLocale.format(subLoanAward) + ". AY (1) begins " + loanPeriodSd + ", Total Credits/Weeks: " + creditsWeeks + ", " + "Program: "+ program + ". " + "Tuition Rate $" + dollarUSLocale.format(tuitionRate1) +". COA: " + costofAttendance1 + ". " + upperCase2 + " NSLDS borrowed $" + dollarUSLocale.format(nsldsAggLimit1) + ". " + aggs1 + " until aggregate limits reached. " + mpnUpperCase2 + " " + " " + extra + " " + "Ready to Disburse."; 
    ...
    var dollarIndianLocale = Intl.NumberFormat('en-IN');
       ...
       var note = "Packaged awards for " + "Unsubsidized Loan $" + dollarUSLocale.format(unsubLoanAward) + ". AY (1) begins " + loanPeriodSd + ", Total Credits/Weeks: " + creditsWeeks + ", " + "Program: "+ program + ". " + "Tuition Rate $" + dollarUSLocale.format(tuitionRate1) +". COA: " + costofAttendance1 + ". " + upperCase2 + " NSLDS borrowed $" + dollarUSLocale.format(nsldsAggLimit1) + ". " + aggs1 + " until aggregate limits reached. " + mpnUpperCase2 +  " " + extra + " " + "Ready to Disburse."; 
